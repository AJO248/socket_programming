...
inter_listen_sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
inter_listen_sock.bind((HOST, INTER_PORT))
inter_listen_sock.listen(1)

# Accept inter-server connection from Server 2
print("Server 1 started. Waiting for inter-server connection...")
inter_sock, _ = inter_listen_sock.accept()
print("Inter-server connected.")
